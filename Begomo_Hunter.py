    ...
    with open_fastq(input_fastq) as handle:
        for record in SeqIO.parse(handle, "fastq"):
            ...
            if positions:
                ...
                # ⚠️ Ya no filtramos por tamaño, se conserva siempre
...
def main():
    ...
    if args.read_type == "short":
        ...
        # 3. Kraken2 sobre fragmentos o trimmed (según modo)
        ...
        # 6. Renombrar ensamblaje para BLAST (solo si viralFlye falló)
